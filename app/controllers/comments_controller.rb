class CommentsController < ApplicationController
  ...
  # before_action :moderator_required, only: [:update, :to_published,
  ...
  # Look here: https://github.com/the-teacher/the_comments/blob/master/app/
  #    controllers/concerns/the_comments_controller.rb#L62
  #
