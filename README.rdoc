...
6. There are four variables to set
...
10. You can put these 4 variables in a **.env** file and it is NOT checked into Github.

11. << Removed .travis.yml feature for now >>
